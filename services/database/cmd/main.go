...
import (
	...
	"github.com/jp-cloud/database/internal/handlers"
...
func main() {
	...
	prov := provisioner.NewFromEnv(pool)
	...
	go func() {
		log.Info("database listening", "port", cfg.HTTPPort, "mode", prov.Mode)
